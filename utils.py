...
#             iou = w * h / area[j]
#             if w > 0 and h > 0 and iou > threshold:
#                 merge.append(pos)
...
#             combined_box.label = sorted(
#                 label_scores.keys(), key=lambda label: label_scores[label]
#             )[-1]
...
#     im, text, x, y, rectangle_bgr=(255, 255, 255), size=10, thickness=1
# ):
...
#             (xmin, ymin),
#             (xmax, ymax),
#             constants.COLORS[labels_set.index(label) % len(constants.COLORS)],
#             -1,
#         )
#         cv2.rectangle(
#             bbox_img,
...
#             xmin,
#             ymin - 13,
#             rectangle_bgr=constants.COLORS[
#                 labels_set.index(label) % len(constants.COLORS)
#             ],
#             size=10,
#             thickness=2,
#         )
...
#     query_coords = query_coords - query_shapes / 2.0
#     catalog_coords = catalog_coords - catalog_shapes / 2.0
...
#     query_bbox_coords1 = 1.0 * query_bbox_coords1 / query_bbox_coords1[:, [-1]]
#     query_bbox_coords2 = 1.0 * query_bbox_coords2 / query_bbox_coords2[:, [-1]]
#     query_bbox_coords3 = 1.0 * query_bbox_coords3 / query_bbox_coords3[:, [-1]]
#     query_bbox_coords4 = 1.0 * query_bbox_coords4 / query_bbox_coords4[:, [-1]]
...
#     xmin = (
#         min(
#             query_bbox_coords1[0],
#             query_bbox_coords2[0],
#             query_bbox_coords3[0],
#             query_bbox_coords4[0],
#         )
#         + query_shapes[0, 0] / 2.0
#     )
#     xmax = (
#         max(
#             query_bbox_coords1[0],
...
#     ymin = (
#         min(
#             query_bbox_coords1[1],
#             query_bbox_coords2[1],
#             query_bbox_coords3[1],
#             query_bbox_coords4[1],
#         )
#         + query_shapes[0, 1] / 2.0
#     )
#     ymax = (
#         max(
#             query_bbox_coords1[1],
...
#         return None
#     if (
#         xmin < -0.5 * query_shapes[0, 0]
#         or xmax > 1.5 * query_shapes[0, 0]
#         or ymin < -0.5 * query_shapes[0, 1]
#         or ymax > 1.5 * query_shapes[0, 1]
#     ):
#         return None
